...
- **Commercial model:** The public pricing ladder is Starter USD 1,500/month, Growth USD 2,000/month, and Embedded USD 3,500+/month. These USD values are public reference anchors, not a requirement that every contract be billed in USD. Before kickoff, the monthly amount is fixed in the client's agreed billing currency, such as USD, BRL, or another mutually accepted currency. Growth is the main and most selected plan because it uses intelligent allocation across the part of the product that needs the most attention each week. Frame pricing as output efficiency, low bureaucracy, smart allocation, and practical product delivery capacity that often costs less than hiring one senior engineer in US and many international markets. Do not frame Tg Apps as cheap labor or a vague retainer. Clients keep the selected plan rate fixed while the engagement remains active.
- **Capacity model:** Tg Apps does not sell a fixed bank of hours. Do not define plans as 20h/40h/80h/160h packages. Plans define delivery cadence, priority capacity, communication rhythm, availability, and operational integration. Before kickoff, the client and Tg Apps align the first milestone, active workstreams, response rhythm, and what can realistically move inside the selected monthly plan.
...
- In Portuguese, visible public copy should prefer **“modelos de atuação”**, **“parceiro de entrega”**, **“trabalho integrado à equipe”**, **“atuação em conjunto”**, or **“responsabilidade por uma área”** instead of **“desenvolvimento por assinatura”**. Keep “assinatura” only where useful for SEO, legacy aliases, or explanatory context. Avoid literal imported phrasing such as “apoio embarcado”, “co-delivery”, “ownership”, “handoff”, “lotes focados”, and “primeiro marco”.
- When mentioning price, use the public ladder as a reference: **Starter USD 1,500/month**, **Growth USD 2,000/month**, and **Embedded USD 3,500+/month**. Growth is the default recommendation and the most selected plan. Clarify when needed that the actual monthly amount is fixed before kickoff in the client's agreed billing currency and that the selected plan rate stays fixed while the engagement remains active.
...
| Hero | `Hero.tsx` | Main offer: "Build from zero, rescue what stalled, or add execution where your team needs it." / "Construa do zero, destrave o que travou, ou coloque mais força onde seu time precisa." Snapshot of mobile/web/backend/release continuity, trust stats, and dual CTAs. |
| Selected Work | `CasesSection.tsx` | Public proof layer with logos and short, evidence-based delivery snapshots. Distinguish completed work, ongoing delivery, maintenance, and separate technical projects. |
...
- **Hero**
  ...
  - Title/subtitle should use the current primary positioning: “Build from zero, rescue what stalled, or add execution where your team needs it.” / “Construa do zero, destrave o que travou, ou coloque mais força onde seu time precisa.” Support copy should mention responsibility, continuity, mobile, web, backend, release, and the ability to own a full product, one critical area, or work alongside an existing team.
...
- **Pricing**
  - Plans: Starter USD 1,500/month, Growth USD 2,000/month, Embedded USD 3,500+/month.
  ...
  - Embedded should mention the same delivery capabilities as Growth, plus higher availability, daily coordination when needed, urgent same-day priority shifts when feasible, and more room for interruptions and reprioritization.
  ...
  - Add explicit "capacity, not raw hours" language when answering buyer objections. The correct comparison is not a generic hour count; it is first milestone, active workstreams, response rhythm, priority-change tolerance, coordination needs, and whether Starter, Growth, Embedded, or a custom arrangement fits.
...
- **Billing:** No payment upfront; contracts + invoices via TG Applications. Public prices may be shown in USD for reference, but the actual monthly amount can be fixed in USD, BRL, or another mutually accepted currency before kickoff. W8‑BEN‑E ready.
...
- Pricing: reference the public ladder when relevant: Starter USD 1,500/month, Growth USD 2,000/month, Embedded USD 3,500+/month. Treat those USD values as public references. Reinforce monthly billing, no upfront, no hidden clauses, currency fixed before kickoff in the client's agreed billing currency, and that the selected plan rate stays fixed while the engagement remains active.
- Pricing ladder interpretation: Starter is not a "small app" plan. It is the controlled biweekly rhythm plan. Growth is the intelligent-allocation weekly plan and should feel like the natural default. Embedded starts at USD 3,500+/month and is for the same services with higher availability, daily coordination when needed, urgent priority shifts when feasible, and more tolerance for interruptions.
- Capacity interpretation: never imply that a buyer receives a fixed number of development hours by default. If buyers ask about hours, redirect to delivery capacity: milestone, cadence, active fronts, reprioritization, integration level, and expected output within the selected plan.
...
- The homepage now has a visible pricing ladder through `PricingPlans.tsx`: Starter USD 1,500/month, Growth USD 2,000/month, Embedded USD 3,500+/month. Growth is the central plan and should be described as intelligent allocation.
- The homepage now has a visible First Milestone Guarantee section after pricing. Keep the promise client-facing: one agreed first delivery, working demo, and no invoice for that initial step if the agreed scope is not delivered.
- The durable sitewide positioning, copy, proof, architecture-description, PT-BR, and visual rules are documented in `docs/direcao-site-posicionamento-e-copy.md`. Apply them to the full site, not only the homepage.
