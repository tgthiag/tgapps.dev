...
- **Pricing**
  ...
  - Add explicit "capacity, not raw hours" language when answering buyer objections. The correct comparison is not a generic hour count; it is first milestone, active workstreams, response rhythm, priority-change tolerance, coordination needs, and whether Starter, Growth, Dedicated, or a custom arrangement fits.
...
- Pricing: reference the public ladder when relevant: Starter USD 1,500/month, Growth USD 2,000/month, Dedicated USD 3,500+/month. Treat those USD values as public references. Reinforce monthly billing, no upfront, no hidden clauses, currency fixed before kickoff in the client's agreed billing currency, and that the selected plan rate stays fixed while the engagement remains active.
