...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const bodyLines = [
      ...
      '',
      'Pricing reference: Starter USD 1,500/mo with scheduled deliveries, deploys, and a biweekly planning meeting, Growth USD 2,000/mo as the main plan with smart allocation, weekly delivery rhythm, and one weekly planning/demo meeting, Dedicated USD 3,500+/mo for the same delivery capabilities with higher availability, client daily standups when requested, and urgent priority handling at any time within the agreement. Requested via contact form.'
    ];
